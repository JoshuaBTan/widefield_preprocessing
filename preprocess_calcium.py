...
def run_pipeline(config_file="config.yaml"):
    ...
    # ============ MOUSE → ATLAS workflow ============
        ...
        # brain_mask_mouse is the atlas footprint back-projected to mouse space
        # (i.e., the region of the mouse image that overlaps the atlas).
        ...
        brain_mask_mouse = atlas_in_mouse.astype(bool)        
